...
import '../API_Integration/Fresher_Jobs/apiServices.dart';

class InitialFresherJobs extends StatefulWidget {
  const InitialFresherJobs({Key? key, required this.isVerified}) : super(key: key);
  final bool isVerified;

  @override
  _InitialFresherJobsState createState() => _InitialFresherJobsState();
}

class _InitialFresherJobsState extends State<InitialFresherJobs> {
