...
class InitialInternship extends StatefulWidget {
  const InitialInternship({Key? key, required this.isVerified}) : super(key: key);
  final bool isVerified;

  @override
  _InitialInternshipState createState() => _InitialInternshipState();
}

class _InitialInternshipState extends State<InitialInternship> {
